...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: t('navigation.workspaces'), href: '/workspaces', icon: BuildingOfficeIcon },
    { name: t('navigation.communities'), href: '/communities', icon: UserGroupIcon },
    { name: t('navigation.ideas'), href: '/ideas', icon: LightBulbIcon },
